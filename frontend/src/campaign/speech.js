        ...
        return (
            <div className="row w-100"><div className='col'>
                ...
                <div className='flexbox'>
                    <Flexboard id='board-1' className='flexboard'>
                        <Flexcard id='card1' className='flexcard' draggable='true'>
                            <p className='flexcard'>Card one</p>
                        </Flexcard>
                        <Flexcard id='card2' className='flexcard' draggable='true'>
                            <p className='flexcard'>Card two</p>
                        </Flexcard>
                    </Flexboard>
                </div>
